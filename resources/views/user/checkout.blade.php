            ...
            <div class="col-lg-8">
                ...
                <div class="section-card">
                    ...
                    <div class="mb-0">
                        ...
                        <div class="input-group">
                            ...
                            <textarea class="form-control" rows="3" placeholder="Masukkan alamat lengkap penjemputan"></textarea>
                        </div>
                    </div>
                </div>
                <!-- Pilih Kursi -->
                ...
                <div class="section-card">
                    ...
                    <div class="d-flex flex-column gap-3">
                        <label class="payment-option active" id="pay-cash" onclick="selectPayment('cash')">
                ...
                <div class="summary-sticky">
                    <div class="summary-card">
                        ...
                        <div class="summary-route">
                            ...
                            <div class="d-flex justify-content-between">
                                <div>
                                    ...
                                    <div class="route-value" style="font-size:.85rem;">21 Maret 2026</div>
                                </div>
                                <div class="text-end">
                                    <div class="route-label">Waktu</div>
                                    <div class="route-value" style="font-size:.85rem;">08:00 WITA</div>
                                </div>
                            </div>
                        </div>
                        <div class="mb-2">
                        ...
                        <div class="price-row total">
                            ...
                            <span id="price-total">Rp 5.000</span>
                        </div>
