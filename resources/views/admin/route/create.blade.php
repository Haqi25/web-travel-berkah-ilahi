     ...
     <section class="section">
         <div class="card">
             ...
             <div class="card-body">
                 ...
                 @endif
                <form class="form" action="{{ route('routes.store') }}" method="POST" enctype="multipart/form-data" >
                     @csrf
                     <div class="form-body">
                         <div class="row">
                             <div class="col-md-6">
                                 ...
                                 <div class="form-group">
                                     ...
                                     <input type="text" class="form-control" id="origin"
                                         placeholder="Masukkan awalan rute" name="origin" required>
                                 </div>
                                 ...
                                 <div class="form-group">
                                     ...
                                     <input type="text" class="form-control" id="destination"
                                         placeholder="Masukkan Tujuan rute" name="destination" required>
                                 </div>
                             </div>
