                             ...
                             <div class="col-md-6">
                                 ...
                                 <div class="form-group">
                                     ...
                                     <input type="text" class="form-control" id="name"
                                         placeholder="Masukkan nama mobil" name="name" required>
                                 </div>
                                 ...
                                 <div class="form-group">
                                     ...
                                     <input type="text" class="form-control" id="plate_number"
                                         placeholder="Masukkan Plat Nomor" name="plate_number" required>
                                 </div>
                             </div>
                             <div class="col-md-6">
                                 <div class="category">
                                 ...
                                 <div class="form-group">
                                     ...
                                     <input type="text" class="form-control" id="seat_layout"
                                         placeholder="Masukkan tata letak kursi:contoh 2-3-3-4" name="seat_layout" required>
                                 </div>
